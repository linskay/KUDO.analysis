    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(blank=True, help_text='Введите email', max_length=254, null=True, unique=True, verbose_name='Email')),
                ...
                ('img', models.ImageField(blank=True, default='404 error', null=True, upload_to='media/img/', verbose_name='Изображение')),
